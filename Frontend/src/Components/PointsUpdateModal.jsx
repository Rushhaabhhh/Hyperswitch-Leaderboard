...
const PointsUpdateModal = ({ isOpen, onClose, user, onUpdate }) => {
  ...
  // Predefined point categories and their values
  ...
  const handleUpdatePoints = async () => {
    ...
    const selectedCategory = pointCategories.find(category => category.value === pointsToAdd);
    ...
    try {
      ...
      toast.error(error.response?.data?.error || 'Failed to update points. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
